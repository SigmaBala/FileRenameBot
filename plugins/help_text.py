    ...
    if update_channel:
        try:
            ...
            await update.reply_text(
                text="**You Need To Join The Below Mentioned Channel Before Using Me! **",
...
async def start_me(bot, update):
    ...
    if update_channel:
        try:
            user = await bot.get_chat_member(update_channel, update.chat.id)
            if user.status == "kicked":
               await update.reply_text(" Sorry,You've Been Flooding Me So My Owner Removed You From Using Me If You Think It's An Error Contact : @NandhaSupport")
               return
        except UserNotParticipant:
            await update.reply_text(
                text="**You Need To Join The Below Mentioned Channel Before Using Me! **",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Channel', url='https://t.me/NandhaBots'),
                    InlineKeyboardButton('Support', url='https://t.me/NandhaSupport')
                ]
            ]
        ),
